...
public class KorsAI : MonoBehaviour
{
    ...
    private float[] minDisplayTimes = { 120f, 45f, 20f, 15f, 10f, 5f }; // Min display time for each level
    private float[] maxDisplayTimes = { 120f, 60f, 40f, 30f, 20f, 10f }; // Max display time for each level
